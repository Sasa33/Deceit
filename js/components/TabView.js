...
import PodsListPge from '../pages/PodsListPage'
...
export default class extends Component {
  ...
  render() {
    ...
    return (
      <TabBarIOS
        unselectedTintColor="podManageTab"
        tintColor="#55ACEE"
        barTintColor="white">
        <TabBarIOS.Item
          title='Pods List'
          icon={{uri: base64Icon, scale: 3}}
          selected={tab === 'podListTab'}
          onPress={ this.onTabSelect.bind(this, 'podListTab') }>
          <PodsListPge />
        </TabBarIOS.Item>
        ...
        <TabBarIOS.Item
          ...
          icon={{uri: base64Icon, scale: 3}}
          style={ styles.tabBar }
          selected={tab === 'podManageTab'}
          onPress={ this.onTabSelect.bind(this, 'podManageTab') }>
          <ManagementPage />
        </TabBarIOS.Item>
      </TabBarIOS>
    )
